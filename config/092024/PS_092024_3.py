...
# Third pass: Reduce n_neurons from 256 to 128
# Reduce n_embd from 16 to 8
config = CL_transformers.ModelConfig(vocab_size = 11387, n_head = 1, n_layer = 1, n_embd = 8, n_neurons = 128)
