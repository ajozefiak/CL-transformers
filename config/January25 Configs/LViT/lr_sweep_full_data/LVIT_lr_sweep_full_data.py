...
for lr in learning_rates:
    ...
    # TODO:
    save_path = f'/nobackup1/jozefiak/ATN_LViT/lr_sweep_full_data/{alg}_L{num_layers}_lr_{lr}/seed_{seed}/'

    res = CL_transformers.run_ATN_LViT_V2_experiment(config, alg, alg_params, seed, save_path, cluster, experiment_config)