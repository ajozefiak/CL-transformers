...
# We are going to bring down the neurons to 64, constrain the neurons as much as possible and see if (with a residual connection)
# we still plasticity loss with L2 regularization
config = CL_transformers.ModelConfig(vocab_size = 11387, n_head = 2, n_layer = 1, n_embd = 32, n_neurons = 64, use_resid=True)

seed = int(sys.argv[1])
print(f"Seed: {seed}")
# CLUSTER SAVE_PATH_ROOT
save_path_root = f'Results/PS_092124_constrained_7/seed_{seed}/'
