...
# First Pass
config = CL_transformers.ModelConfig(vocab_size = 50257, n_head = 2, n_layer = 1, n_embd = 16, n_neurons = 64)

# TODO: toggle save_neuron_ages, save_weights
save_results = True
save_neuron_ages = True
save_weights = True
save_weights_freq = 32*epochs*10

# CLUSTER SAVE_PATH_ROOT
save_path_root = f'/nobackup1/jozefiak/CL/Results/ATN/ATN_092324_small/seed_{seed}/'
