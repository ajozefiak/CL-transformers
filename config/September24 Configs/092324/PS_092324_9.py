...
# Here we fixed the random seed in the experiment and now we are running again with 256 neurons to see what happens
...
save_path_root = f'Results/PS_092324_constrained_9/seed_{seed}/'
