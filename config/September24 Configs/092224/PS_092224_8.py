...
# We are going to bring down the neurons to 128, constrain the neurons as much as possible and see if (with a residual connection)
...
save_path_root = f'Results/PS_092224_constrained_8/seed_{seed}/'
