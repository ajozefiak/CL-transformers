...
# First Pass
config = CL_transformers.ModelConfig(vocab_size = 50257, n_head = 2, n_layer = 1, n_embd = 32, n_neurons = 128)
...
save_path_root = f'/nobackup1/jozefiak/CL/Results/ATN/ATN_092424_medium_50_1/seed_{seed}/'
