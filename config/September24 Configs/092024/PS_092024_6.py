...
# Fourth Pass: Increase Task Count to 200, use one head with n_embd = 16, use two layers, n_neurons = 256
config = CL_transformers.ModelConfig(vocab_size = 11387, n_head = 1, n_layer = 2, n_embd = 16, n_neurons = 256)
