...
# Divide tokens into 10 tasks
D_task = int(D_U // 10)

for task in range(10):

    dataloader_train = DataLoader(train_data[D_task * task:D_task * (task+1)], batch_size=batch_size, context_window=context_window, key=key, include_target=True)
    async_dl_train = AsyncDataLoader(dataloader_train)
