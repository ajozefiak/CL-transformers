...
# TODO:
save_path = f'/nobackup1/jozefiak/CI_ViT/opt_h_param_sweep/{alg}_L{num_layers}_lr_{lr}_reset_percentile_{reset_percentile}_reset_freq_{reset_freq}/seed_{seed}/'
