...
if layers == 3:
    reg_str = 1e-3
    # reg_str = 1e-3 is the correct one, but only slightly better than 1e-4 which I ran earlier
if layers == 12 and lr == 1e-3:
    reg_str = 1e-4
    # reg_str = 1e-4 is the correct one, slightly better than 1e-3 which I ran earlier
if layers == 12 and lr == 1e-4:
    reg_str = 1e-5
    # This one is correct, which I ran originally
...
# TODO:
save_path = f'/pool001/jozefiak/CI_ViT/opt_h_param_sweep_fixed/{alg}_L{num_layers}_lr_{lr}_reg_str_{reg_str}/seed_{seed}/'
