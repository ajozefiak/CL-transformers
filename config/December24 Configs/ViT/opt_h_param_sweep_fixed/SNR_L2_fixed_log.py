...
if layers == 12 and lr == 1e-4:
    ...
    reset_freq = 1 / (32 * batches * epochs)
...
# TODO:
save_path = f'/pool001/jozefiak/CI_ViT/opt_h_param_sweep_fixed/{alg}_L{num_layers}_lr_{lr}_reg_str_{reg_str}_reset_percentile_{reset_percentile}_reset_freq_{reset_freq}/seed_{seed}/'
