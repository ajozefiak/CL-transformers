...
def run_experiment_Alt_CATN(alg, alg_params, datasets_A, datasets_B, B, T, art_per_task, epochs, months, percent_mixing, seed, save_neuron_ages, save_results, save_path, verbose, print_freq):
